...
def find_authors_nationalities():
    authors_nationalities_not_null = Author.objects.exclude(nationality=None)
    authors_data = []

    for author in authors_nationalities_not_null:
        authors_data.append(
...
def delete_review_by_id(review_id):
    deleted_record_by_given_id = Review.objects.get(id=review_id)
    deleted_record_by_given_id.delete()
    return f"{str(deleted_record_by_given_id)} was deleted"
